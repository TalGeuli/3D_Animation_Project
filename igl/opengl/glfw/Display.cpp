...
bool Display::launch_rendering(bool loop)
{
	...
	Shader skyboxShader("skyboxCube.vs", "skyboxCube.fs");
	...
	{
		FileSystem::getPath("/tutorial/textures/right.bmp"),
		FileSystem::getPath("/tutorial/textures/left.bmp"),
		FileSystem::getPath("/tutorial/textures/top.bmp"),
		FileSystem::getPath("/tutorial/textures/bottom.bmp"),
		FileSystem::getPath("/tutorial/textures/front.bmp"),
		FileSystem::getPath("/tutorial/textures/back.bmp")
	};
